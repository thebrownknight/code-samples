...
class DistanceVector: public Node {
    ...
    public:
        ...
        RoutingMessage *getDistanceVector();
        void updateRoutingTable(RoutingMessage *m);
        void updateForwardingTable(int nodeID, Node *nextHopNode);
        int updateDistanceVector();
};

inline ostream & operator<<(ostream & os, const DistanceVector & n) { return n.Print(os); }
